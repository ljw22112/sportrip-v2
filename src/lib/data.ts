...
export const EVENTS:SportEvent[]=[
  ...
  {id:248,title:'2026 춘천마라톤',sport:'마라톤',icon:'🏃',venue:'춘천종합운동장',address:'강원 춘천시',start:'2026-10-11',end:'2026-10-11',status:'upcoming',region:'강원',desc:'2026 춘천마라톤. 강원 개최.',url:'https://www.kormarathon.com/ko/races/2026-chuncheon-marathon',participants:'30000명',lat:37.8747,lng:127.7341,distances:'하프·풀코스'},
