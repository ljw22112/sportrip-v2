...
export const EVENTS:SportEvent[]=[
  ...
  {id:246,title:'2026 평택시장배 배드민턴대회',sport:'배드민턴',icon:'🏸',venue:'이충문화체육센터·이충실내배드민턴장',address:'경기 평택시',start:'2026-09-05',end:'2026-09-06',status:'upcoming',region:'경기',desc:'2026 평택시장배 배드민턴대회. 경기 개최.',url:'https://www.courtx.co.kr/Tournament/Details/30326',participants:'미정',lat:37.0073,lng:127.0,distances:'복식·혼합복식·단식'},
