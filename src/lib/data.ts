...
export const EVENTS:SportEvent[]=[
  ...
  {id:6,title:'2026 부산국제마라톤',sport:'마라톤',icon:'🏃',venue:'광안리해수욕장',address:'부산 수영구 광안해변로 219',start:'2026-10-04',end:'2026-10-04',status:'upcoming',region:'부산',desc:'광안대교를 달리는 특별한 코스.',url:'https://marathon.busan.com',participants:'20,000명',lat:35.1531,lng:129.1183,distances:'풀코스·하프·10K'},
  {id:7,title:'2026 제주올레마라톤',sport:'마라톤',icon:'🏃',venue:'제주 올레길 7코스',address:'제주 서귀포시 칠십리로 214번길',start:'2026-10-11',end:'2026-10-11',status:'upcoming',region:'제주',desc:'제주 올레길 힐링 마라톤.',url:'https://www.jejuollerunning.com',participants:'8,000명',lat:33.2541,lng:126.56,distances:'하프·10K·5K'},
  {id:8,title:'2026 전주마라톤',sport:'마라톤',icon:'🏃',venue:'전주 한옥마을 출발',address:'전북 전주시 완산구 기린대로 99',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'전북',desc:'한옥마을을 지나는 전통 코스.',url:'https://www.jjmarathon.com',participants:'10,000명',lat:35.8156,lng:127.1535,distances:'풀코스·하프·10K'},
  {id:9,title:'2026 광주마라톤',sport:'마라톤',icon:'🏃',venue:'광주 무등산공원',address:'광주 북구 무등로 1600',start:'2026-10-25',end:'2026-10-25',status:'upcoming',region:'광주',desc:'무등산 경관을 즐기며 달리는 마라톤.',url:'https://www.gjmarathon.com',participants:'12,000명',lat:35.135,lng:126.988,distances:'풀코스·하프·10K'},
  {id:10,title:'2026 대구마라톤',sport:'마라톤',icon:'🏃',venue:'대구 두류공원',address:'대구 달서구 두류공원로 200',start:'2026-11-01',end:'2026-11-01',status:'upcoming',region:'대구',desc:'대구 도심을 달리는 가을 마라톤.',url:'https://www.daegumarathon.co.kr',participants:'15,000명',lat:35.8666,lng:128.5644,distances:'풀코스·하프·10K'},
  {id:11,title:'2026 인천마라톤',sport:'마라톤',icon:'🏃',venue:'인천 송도국제도시',address:'인천 연수구 컨벤시아대로 165',start:'2026-11-08',end:'2026-11-08',status:'upcoming',region:'인천',desc:'송도 센트럴파크 주변 코스.',url:'https://www.incheonmarathon.com',participants:'10,000명',lat:37.383,lng:126.6565,distances:'풀코스·하프·10K'},
  {id:12,title:'2026 코리아오픈 배드민턴',sport:'배드민턴',icon:'🏸',venue:'고양 킨텍스',address:'경기 고양시 일산서구 킨텍스로 217-60',start:'2026-10-20',end:'2026-10-25',status:'upcoming',region:'경기',desc:'BWF 슈퍼 500 국제 배드민턴 오픈.',url:'https://www.koreaopenbc.org',participants:'3,000명',lat:37.6744,lng:126.7617,distances:'남녀 단복식'},
  ...
  {id:18,title:'2026 오대산 국제 트레일런',sport:'트레일',icon:'🏃',venue:'강원 오대산 국립공원',address:'강원 평창군 진부면 오대산로 2',start:'2026-10-10',end:'2026-10-11',status:'upcoming',region:'강원',desc:'오대산을 달리는 국제 트레일.',url:'https://www.odaetrail.com',participants:'3,000명',lat:37.7975,lng:128.5439,distances:'50K·30K·15K'},
  {id:19,title:'2026 설악산 국제 트레일런',sport:'트레일',icon:'🏃',venue:'강원 설악산국립공원',address:'강원 속초시 설악동 170',start:'2026-10-24',end:'2026-10-25',status:'upcoming',region:'강원',desc:'설악 단풍 속 국제 레이스.',url:'https://www.soraktrail.com',participants:'2,500명',lat:38.1195,lng:128.4659,distances:'40K·20K'},
  {id:20,title:'2026 제주 국제 철인3종',sport:'기타',icon:'🏊',venue:'제주 중문관광단지',address:'제주 서귀포시 중문관광로 72번길',start:'2026-10-31',end:'2026-11-01',status:'upcoming',region:'제주',desc:'수영·자전거·달리기 통합 철인3종.',url:'https://www.jeju-ironman.com',participants:'2,000명',lat:33.2457,lng:126.4107,distances:'올림픽·스프린트'},
  {id:21,title:'2026 하나금융 코리아오픈 테니스',sport:'테니스',icon:'🎾',venue:'올림픽공원 테니스장',address:'서울 송파구 올림픽로 424',start:'2026-10-05',end:'2026-10-11',status:'upcoming',region:'서울',desc:'ATP 250 국제 테니스 대회.',url:'https://www.koreatennisopen.com',participants:'5,000명',lat:37.5203,lng:127.1234,distances:'남자프로테니스'},
  {id:22,title:'2026 전국사이클선수권',sport:'사이클',icon:'🚴',venue:'청주 벨로드롬',address:'충북 청주시 청원구 오창읍',start:'2026-10-09',end:'2026-10-12',status:'upcoming',region:'충북',desc:'전국 사이클 도로·트랙 선수권.',url:'https://www.koreacycling.or.kr',participants:'800명',lat:36.6721,lng:127.4291,distances:'도로·트랙'},
  ...
  {id:31,title:'2026 전국마라톤 랭킹전',sport:'마라톤',icon:'🏃',venue:'수원종합운동장',address:'경기 수원시 장안구 경수대로 731',start:'2026-11-22',end:'2026-11-22',status:'upcoming',region:'경기',desc:'전국 마라톤 연간 랭킹 결정전.',url:'https://www.kaaf.or.kr',participants:'5,000명',lat:37.2804,lng:127.0127,distances:'풀코스·하프'},
  {id:32,title:'2026 대구국제마라톤',sport:'마라톤',icon:'🏃',venue:'대구 야구장 앞',address:'대구 수성구 야구전설로 1',start:'2026-11-22',end:'2026-11-22',status:'upcoming',region:'대구',desc:'대구 도심 코스 국제 마라톤.',url:'https://www.daegumarathon.co.kr',participants:'12,000명',lat:35.8412,lng:128.6817,distances:'풀코스·하프·10K'},
  {id:33,title:'2026 창원국제마라톤',sport:'마라톤',icon:'🏃',venue:'창원 용지공원',address:'경남 창원시 성산구 용지로 207',start:'2026-11-08',end:'2026-11-08',status:'upcoming',region:'경남',desc:'창원 공단길 국제 마라톤.',url:'https://www.cwmarathon.com',participants:'10,000명',lat:35.2279,lng:128.6811,distances:'풀코스·하프·10K'},
  {id:34,title:'2026 군산새만금마라톤',sport:'마라톤',icon:'🏃',venue:'새만금 방조제',address:'전북 군산시 오식도동 새만금로',start:'2026-11-15',end:'2026-11-15',status:'upcoming',region:'전북',desc:'새만금 방조제를 달리는 특별한 코스.',url:'https://www.gsmarathon.com',participants:'8,000명',lat:35.8234,lng:127.1289,distances:'풀코스·하프·10K'},
  {id:35,title:'2026 하동섬진강마라톤',sport:'마라톤',icon:'🏃',venue:'섬진강 둑길',address:'경남 하동군 하동읍 섬진강대로 2312',start:'2026-11-01',end:'2026-11-01',status:'upcoming',region:'경남',desc:'섬진강 따라 달리는 가을 마라톤.',url:'https://www.hadongmarathon.com',participants:'5,000명',lat:35.0674,lng:127.7518,distances:'풀코스·하프·10K'},
  {id:36,title:'2026 남해독일마을마라톤',sport:'마라톤',icon:'🏃',venue:'남해 독일마을',address:'경남 남해군 삼동면 물건리 888',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'경남',desc:'남해 바다 보며 달리는 마라톤.',url:'https://www.namhaemarathon.com',participants:'3,000명',lat:34.8238,lng:127.9218,distances:'하프·10K·5K'},
  {id:37,title:'2026 전국 시·군·구 마라톤',sport:'마라톤',icon:'🏃',venue:'대전 엑스포 시민광장',address:'대전 유성구 대덕대로 480',start:'2026-11-08',end:'2026-11-08',status:'upcoming',region:'대전',desc:'전국 지자체 대항 마라톤 축제.',url:'https://www.kaaf.or.kr',participants:'15,000명',lat:36.3741,lng:127.3876,distances:'풀코스·하프'},
  {id:38,title:'2026 전국 학생 마라톤대회',sport:'마라톤',icon:'🏃',venue:'서울 여의도 한강공원',address:'서울 영등포구 여의도동 한강공원',start:'2026-11-07',end:'2026-11-07',status:'upcoming',region:'서울',desc:'초·중·고 학생 마라톤 축제.',url:'https://www.kaaf.or.kr',participants:'10,000명',lat:37.5289,lng:126.9328,distances:'3K·5K·10K'},
  {id:39,title:'2026 지리산 국제 트레일런',sport:'트레일',icon:'🏃',venue:'경남 하동군 화개면',address:'경남 하동군 화개면 탑리 지리산',start:'2026-10-17',end:'2026-10-18',status:'upcoming',region:'경남',desc:'지리산 능선 국제 레이스.',url:'https://www.jiritrail.com',participants:'2,000명',lat:35.296,lng:127.5802,distances:'60K·30K·15K'},
  {id:40,title:'2026 신한동해오픈 골프',sport:'골프',icon:'⛳',venue:'강릉 스카이밸리CC',address:'강원 강릉시 성산면',start:'2026-10-15',end:'2026-10-18',status:'upcoming',region:'강원',desc:'KPGA 코리안투어 대회.',url:'https://www.kgto.co.kr',participants:'500명',lat:37.7382,lng:128.8651,distances:'72홀 스트로크'},
  ...
  {id:71,title:'2026 통영 철인3종대회',sport:'기타',icon:'🏊',venue:'통영 한산만',address:'경남 통영시 도남로 169',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'경남',desc:'한산도 앞바다 철인3종.',url:'https://www.tongyeongtriathlon.com',participants:'1,200명',lat:34.8544,lng:128.4331,distances:'올림픽거리'},
  {id:72,title:'2026 전국 드래곤보트선수권',sport:'기타',icon:'🚣',venue:'춘천 의암호',address:'강원 춘천시 서면 의암호',start:'2026-10-24',end:'2026-10-26',status:'upcoming',region:'강원',desc:'의암호 드래곤보트 레이스.',url:'https://www.dragonboat.or.kr',participants:'800명',lat:37.8813,lng:127.7298,distances:'200m·500m·2km'},
  {id:73,title:'2026 여수 국제스포츠대회',sport:'종합',icon:'🏅',venue:'여수종합체육관',address:'전남 여수시 여서동 1500-4',start:'2026-10-28',end:'2026-11-02',status:'upcoming',region:'전남',desc:'여수를 빛낼 국제 스포츠 종합대회.',url:'https://www.sports.or.kr',participants:'5,000명',lat:34.7425,lng:127.7274,distances:'종합'},
  {id:74,title:'2026 전국 트라이애슬론선수권',sport:'기타',icon:'🏊',venue:'하남 미사경정공원',address:'경기 하남시 미사동 616',start:'2026-10-25',end:'2026-10-25',status:'upcoming',region:'경기',desc:'전국 트라이애슬론 선수권.',url:'https://www.triathlon.or.kr',participants:'800명',lat:37.559,lng:127.196,distances:'올림픽거리'},
  {id:75,title:'2026 전국근대5종선수권',sport:'기타',icon:'🏇',venue:'진천 국가대표선수촌',address:'충북 진천군 덕산읍 국가대표로 400',start:'2026-10-15',end:'2026-10-18',status:'upcoming',region:'충북',desc:'전국 근대5종 선수권.',url:'https://www.sports.or.kr',participants:'300명',lat:36.8997,lng:127.4318,distances:'전통5종'},
  {id:76,title:'2026 전국카누선수권',sport:'기타',icon:'🛶',venue:'하남 미사경정공원',address:'경기 하남시 미사동 616',start:'2026-10-20',end:'2026-10-23',status:'upcoming',region:'경기',desc:'전국 카누·카약 선수권.',url:'https://www.canoeing.or.kr',participants:'600명',lat:37.559,lng:127.196,distances:'카누·카약'},
  ...
  {id:80,title:'2026 제주 국제 사이클 그랑프리',sport:'사이클',icon:'🚴',venue:'제주 환상자전거도로',address:'제주 제주시 애월읍 광성리',start:'2026-11-05',end:'2026-11-08',status:'upcoming',region:'제주',desc:'제주 환상 자전거 도로 국제대회.',url:'https://www.koreacycling.or.kr',participants:'1,000명',lat:33.4743,lng:126.3922,distances:'도로·개인TT'},
  {id:81,title:'2026 전국 실내사이클선수권',sport:'사이클',icon:'🚴',venue:'광명 스피돔',address:'경기 광명시 도덕산로 88',start:'2026-11-04',end:'2026-11-07',status:'upcoming',region:'경기',desc:'전국 실내트랙 사이클 선수권.',url:'https://www.koreacycling.or.kr',participants:'500명',lat:37.4396,lng:126.8555,distances:'스프린트·개인추발'},
  {id:82,title:'2026 전국레슬링선수권',sport:'기타',icon:'🤼',venue:'의정부 실내체육관',address:'경기 의정부시 의정부동 100-1',start:'2026-10-28',end:'2026-11-01',status:'upcoming',region:'경기',desc:'전국 레슬링 남녀 선수권.',url:'https://www.kor-wrestling.or.kr',participants:'600명',lat:37.738,lng:127.0438,distances:'자유형·그레코로만'},
  ...
  {id:96,title:'2026 전국 체력왕선발대회',sport:'종합',icon:'🏋️',venue:'서울 올림픽체조경기장',address:'서울 송파구 올림픽로 424',start:'2026-11-21',end:'2026-11-22',status:'upcoming',region:'서울',desc:'전국민 체력왕 선발 대회.',url:'https://www.sports.or.kr',participants:'5,000명',lat:37.5193,lng:127.1267,distances:'종합체력'},
  {id:97,title:'2026 KBL 프로농구 시즌 특별전',sport:'농구',icon:'🏀',venue:'서울 잠실실내체육관',address:'서울 송파구 올림픽로 25',start:'2026-11-15',end:'2026-11-15',status:'upcoming',region:'서울',desc:'KBL 스타플레이어 올스타 특별전.',url:'https://www.kbl.or.kr',participants:'15,000명',lat:37.5149,lng:127.0738,distances:'프로농구'},
  ...
  {id:101,title:'2026 전국 역도 국제대회',sport:'기타',icon:'🏋️',venue:'수원 실내체육관',address:'경기 수원시 팔달구 효원로 241',start:'2026-11-18',end:'2026-11-21',status:'upcoming',region:'경기',desc:'국제역도연맹 공인 대회.',url:'https://www.sports.or.kr',participants:'800명',lat:37.2636,lng:127.0286,distances:'남녀급별'},
  {id:102,title:'2026 대구광역시 종별체육대회',sport:'종합',icon:'🏅',venue:'대구 두류공원',address:'대구 달서구 두류공원로 200',start:'2026-10-28',end:'2026-11-02',status:'upcoming',region:'대구',desc:'대구 8개 구·군 스포츠 축제.',url:'https://www.sports.or.kr',participants:'5,000명',lat:35.8666,lng:128.5644,distances:'종합'},
  ...
  {id:104,title:'잠실 새벽 러닝 크루전 8K',sport:'러닝',icon:'💨',venue:'잠실한강공원 수변무대',address:'서울 잠실',start:'2026-08-08',end:'2026-08-08',status:'upcoming',region:'서울',desc:'잠실 새벽 러닝 크루전 8K. 서울 잠실 개최.',url:'https://www.runningcrew.co.kr',participants:'1,200명',lat:37.518,lng:127.082,distances:'8km'},
  {id:105,title:'부천 실내 배드민턴 위크리그',sport:'배드민턴',icon:'🏸',venue:'부천체육관 보조경기장',address:'경기 부천',start:'2026-08-09',end:'2026-08-09',status:'upcoming',region:'경기',desc:'부천 실내 배드민턴 위크리그. 경기 부천 개최.',url:'https://www.badmintonkorea.org',participants:'480명',lat:37.505,lng:126.763,distances:'복식'},
  {id:106,title:'인천 송도 새벽 러닝 5K',sport:'러닝',icon:'💨',venue:'송도 센트럴파크 잔디광장',address:'인천 송도',start:'2026-08-16',end:'2026-08-16',status:'upcoming',region:'인천',desc:'인천 송도 새벽 러닝 5K. 인천 송도 개최.',url:'https://www.kaaf.or.kr',participants:'1,500명',lat:37.393,lng:126.64,distances:'5km'},
  {id:107,title:'한강 나이트런 10K',sport:'러닝',icon:'💨',venue:'여의도한강공원 이벤트광장',address:'서울 여의도',start:'2026-08-22',end:'2026-08-22',status:'upcoming',region:'서울',desc:'한강 나이트런 10K. 서울 여의도 개최.',url:'https://www.nightrun.co.kr',participants:'3,000명',lat:37.528,lng:126.933,distances:'10km'},
  {id:108,title:'대천해수욕장 오픈워터 스윔',sport:'수영',icon:'🏊',venue:'대천해수욕장 분수광장',address:'충남 보령',start:'2026-08-29',end:'2026-08-29',status:'upcoming',region:'충남',desc:'대천해수욕장 오픈워터 스윔. 충남 보령 개최.',url:'https://www.openwater.co.kr',participants:'600명',lat:36.32,lng:126.512,distances:'1.5km·800m'},
  {id:109,title:'수원 아마추어 풋살 리그전',sport:'축구',icon:'⚽',venue:'수원종합운동장 보조구장',address:'경기 수원',start:'2026-08-30',end:'2026-08-30',status:'upcoming',region:'경기',desc:'수원 아마추어 풋살 리그전. 경기 수원 개최.',url:'https://www.futsal.co.kr',participants:'640명',lat:37.298,lng:127.01,distances:'5인제'},
  {id:110,title:'전국수상스키·웨이크보드',sport:'기타',icon:'🏆',venue:'충주호 수상레저',address:'충북 충주',start:'2026-08-03',end:'2026-08-05',status:'done',region:'충북',desc:'전국수상스키·웨이크보드. 충북 충주 개최.',url:'https://www.sports.or.kr',participants:'400명',lat:37.009,lng:127.985,distances:'수상스키·웨이크보드'},
  {id:111,title:'서울 도심 자전거 100K',sport:'사이클',icon:'🚴',venue:'서울월드컵경기장',address:'서울 마포',start:'2026-08-15',end:'2026-08-15',status:'upcoming',region:'서울',desc:'서울 도심 자전거 100K. 서울 마포 개최.',url:'https://www.bikeseoul.com',participants:'2,000명',lat:37.5686,lng:126.8973,distances:'100km·60km'},
  {id:112,title:'춘천 오픈 배드민턴',sport:'배드민턴',icon:'🏸',venue:'춘천실내체육관',address:'강원 춘천',start:'2026-08-23',end:'2026-08-24',status:'upcoming',region:'강원',desc:'춘천 오픈 배드민턴. 강원 춘천 개최.',url:'https://www.badmintonkorea.org',participants:'800명',lat:37.88,lng:127.73,distances:'단식·복식'},
  {id:113,title:'대구 서머 러닝 페스티벌',sport:'러닝',icon:'💨',venue:'수성못 일대',address:'대구 수성',start:'2026-08-30',end:'2026-08-30',status:'upcoming',region:'대구',desc:'대구 서머 러닝 페스티벌. 대구 수성 개최.',url:'https://www.kaaf.or.kr',participants:'2,500명',lat:35.86,lng:128.62,distances:'10K·5K·3K'},
  {id:114,title:'제주 올레 러닝 5K',sport:'러닝',icon:'💨',venue:'서귀포 이순신광장',address:'제주 서귀포',start:'2026-08-09',end:'2026-08-09',status:'upcoming',region:'제주',desc:'제주 올레 러닝 5K. 제주 서귀포 개최.',url:'https://www.kaaf.or.kr',participants:'1,800명',lat:33.254,lng:126.56,distances:'5km'},
  {id:115,title:'전주 한옥마을 배드민턴',sport:'배드민턴',icon:'🏸',venue:'전주실내체육관',address:'전북 전주',start:'2026-08-16',end:'2026-08-17',status:'upcoming',region:'전북',desc:'전주 한옥마을 배드민턴. 전북 전주 개최.',url:'https://www.badmintonkorea.org',participants:'600명',lat:35.823,lng:127.129,distances:'복식'},
  {id:116,title:'광주 생활체육 수영대회',sport:'수영',icon:'🏊',venue:'광주북구실내수영장',address:'광주 북구',start:'2026-08-22',end:'2026-08-23',status:'upcoming',region:'광주',desc:'광주 생활체육 수영대회. 광주 북구 개최.',url:'https://www.swimming.or.kr',participants:'500명',lat:35.25,lng:126.9,distances:'자유형·배영'},
  {id:117,title:'부산 어시장 마라톤',sport:'마라톤',icon:'🏃',venue:'자갈치해안로',address:'부산 중구',start:'2026-08-01',end:'2026-08-01',status:'done',region:'부산',desc:'부산 어시장 마라톤. 부산 중구 개최.',url:'https://www.kaaf.or.kr',participants:'3,000명',lat:35.096,lng:129.036,distances:'하프·10K'},
  {id:118,title:'양평 두물머리 그란폰도',sport:'사이클',icon:'🚴',venue:'양평 물맑은시장',address:'경기 양평',start:'2026-09-12',end:'2026-09-12',status:'upcoming',region:'경기',desc:'양평 두물머리 그란폰도. 경기 양평 개최.',url:'https://www.koreacycling.or.kr',participants:'2,000명',lat:37.492,lng:127.487,distances:'120km·70km'},
  {id:119,title:'전국 생활체육 배드민턴 대회',sport:'배드민턴',icon:'🏸',venue:'대전 유성종합체육관',address:'대전 유성',start:'2026-09-05',end:'2026-09-06',status:'upcoming',region:'대전',desc:'전국 생활체육 배드민턴 대회. 대전 유성 개최.',url:'https://www.badmintonkorea.org',participants:'1,200명',lat:36.362,lng:127.356,distances:'단식·복식'},
  {id:120,title:'통영 오픈워터 스윔',sport:'수영',icon:'🏊',venue:'통영 도남관광지 요트장',address:'경남 통영',start:'2026-09-19',end:'2026-09-20',status:'upcoming',region:'경남',desc:'통영 오픈워터 스윔. 경남 통영 개최.',url:'https://www.tongyeong-swim.com',participants:'800명',lat:34.828,lng:128.418,distances:'3km·1.5km'},
  {id:121,title:'설악 그란트레일 30K',sport:'트레일',icon:'🏆',venue:'설악산 소공원',address:'강원 속초',start:'2026-09-10',end:'2026-09-11',status:'upcoming',region:'강원',desc:'설악 그란트레일 30K. 강원 속초 개최.',url:'https://www.soraktrail.com',participants:'900명',lat:38.173,lng:128.49,distances:'30km·15km'},
  {id:122,title:'송도 오픈 테니스',sport:'테니스',icon:'🎾',venue:'송도국제테니스장',address:'인천 송도',start:'2026-09-03',end:'2026-09-05',status:'upcoming',region:'인천',desc:'송도 오픈 테니스. 인천 송도 개최.',url:'https://www.songdoopen.com',participants:'400명',lat:37.389,lng:126.643,distances:'단식·복식'},
  {id:123,title:'태화강 십리대숲 러닝 10K',sport:'러닝',icon:'💨',venue:'태화강국가정원',address:'울산 중구',start:'2026-09-13',end:'2026-09-13',status:'upcoming',region:'울산',desc:'태화강 십리대숲 러닝 10K. 울산 중구 개최.',url:'https://www.kaaf.or.kr',participants:'2,200명',lat:35.552,lng:129.288,distances:'10km'},
  {id:124,title:'청주 무심천 배드민턴 오픈',sport:'배드민턴',icon:'🏸',venue:'청주체육관',address:'충북 청주',start:'2026-09-20',end:'2026-09-21',status:'upcoming',region:'충북',desc:'청주 무심천 배드민턴 오픈. 충북 청주 개최.',url:'https://www.badmintonkorea.org',participants:'900명',lat:36.628,lng:127.457,distances:'복식'},
  {id:125,title:'김해 가야 테니스 클래식',sport:'테니스',icon:'🎾',venue:'김해운동장 테니스코트',address:'경남 김해',start:'2026-09-26',end:'2026-09-27',status:'upcoming',region:'경남',desc:'김해 가야 테니스 클래식. 경남 김해 개최.',url:'https://www.kortennis.co.kr',participants:'350명',lat:35.234,lng:128.889,distances:'복식'},
  {id:126,title:'전국마라톤동호인 클럽리그전',sport:'마라톤',icon:'🏃',venue:'고양 호수공원',address:'경기 고양',start:'2026-09-06',end:'2026-09-06',status:'upcoming',region:'경기',desc:'전국마라톤동호인 클럽리그전. 경기 고양 개최.',url:'https://www.kaaf.or.kr',participants:'4,000명',lat:37.674,lng:126.762,distances:'풀코스·하프'},
  {id:127,title:'서울 한강 자전거 100K',sport:'사이클',icon:'🚴',venue:'광진구 한강공원',address:'서울 광진',start:'2026-09-20',end:'2026-09-20',status:'upcoming',region:'서울',desc:'서울 한강 자전거 100K. 서울 광진 개최.',url:'https://www.koreacycling.or.kr',participants:'1,500명',lat:37.54,lng:127.08,distances:'100km·50km'},
  {id:128,title:'전주 한옥마을 하프마라톤',sport:'마라톤',icon:'🏃',venue:'전주종합경기장',address:'전북 전주',start:'2026-09-27',end:'2026-09-27',status:'upcoming',region:'전북',desc:'전주 한옥마을 하프마라톤. 전북 전주 개최.',url:'https://www.kaaf.or.kr',participants:'5,000명',lat:35.815,lng:127.153,distances:'하프·10km'},
  {id:129,title:'광주 왕중왕 배드민턴',sport:'배드민턴',icon:'🏸',venue:'광주염주종합체육관',address:'광주 서구',start:'2026-09-12',end:'2026-09-13',status:'upcoming',region:'광주',desc:'광주 왕중왕 배드민턴. 광주 서구 개최.',url:'https://www.badmintonkorea.org',participants:'1,000명',lat:35.149,lng:126.872,distances:'복식'},
  {id:130,title:'경주 코스모스 러닝',sport:'러닝',icon:'💨',venue:'보문단지',address:'경북 경주',start:'2026-09-19',end:'2026-09-19',status:'upcoming',region:'경북',desc:'경주 코스모스 러닝. 경북 경주 개최.',url:'https://www.kaaf.or.kr',participants:'3,000명',lat:35.853,lng:129.269,distances:'10K·5K'},
  {id:131,title:'춘천 아이언맨 70.3',sport:'기타',icon:'🏆',venue:'의암호 일원',address:'강원 춘천',start:'2026-09-13',end:'2026-09-14',status:'upcoming',region:'강원',desc:'춘천 아이언맨 70.3. 강원 춘천 개최.',url:'https://www.ironman.com/im703-korea',participants:'1,200명',lat:37.88,lng:127.73,distances:'중거리 철인3종'},
  {id:132,title:'여수 낙조 마라톤',sport:'마라톤',icon:'🏃',venue:'여수 이순신광장',address:'전남 여수',start:'2026-09-05',end:'2026-09-05',status:'upcoming',region:'전남',desc:'여수 낙조 마라톤. 전남 여수 개최.',url:'https://www.kaaf.or.kr',participants:'4,000명',lat:34.743,lng:127.735,distances:'하프·10K'},
  {id:133,title:'대전 갑천 자전거 마라톤',sport:'사이클',icon:'🚴',venue:'갑천 자전거도로',address:'대전 서구',start:'2026-09-26',end:'2026-09-26',status:'upcoming',region:'대전',desc:'대전 갑천 자전거 마라톤. 대전 서구 개최.',url:'https://www.koreacycling.or.kr',participants:'1,000명',lat:36.35,lng:127.38,distances:'50km·30km'},
  {id:134,title:'경남 고성 공룡 마라톤',sport:'마라톤',icon:'🏃',venue:'고성군 종합운동장',address:'경남 고성',start:'2026-09-13',end:'2026-09-13',status:'upcoming',region:'경남',desc:'경남 고성 공룡 마라톤. 경남 고성 개최.',url:'https://www.kaaf.or.kr',participants:'3,000명',lat:34.973,lng:128.322,distances:'하프·10K'},
  {id:135,title:'안동 국제 마라톤',sport:'마라톤',icon:'🏃',venue:'안동 경기장',address:'경북 안동',start:'2026-09-06',end:'2026-09-06',status:'upcoming',region:'경북',desc:'안동 국제 마라톤. 경북 안동 개최.',url:'https://www.kaaf.or.kr',participants:'5,000명',lat:36.568,lng:128.729,distances:'풀코스·하프'},
  {id:136,title:'충남 아산 배드민턴 오픈',sport:'배드민턴',icon:'🏸',venue:'아산배드민턴경기장',address:'충남 아산',start:'2026-09-19',end:'2026-09-20',status:'upcoming',region:'충남',desc:'충남 아산 배드민턴 오픈. 충남 아산 개최.',url:'https://www.badmintonkorea.org',participants:'700명',lat:36.79,lng:127.01,distances:'단식·복식'},
  {id:137,title:'제주 한라산 트레일런',sport:'트레일',icon:'🏆',venue:'영실 탐방로 입구',address:'제주 서귀포',start:'2026-09-27',end:'2026-09-27',status:'upcoming',region:'제주',desc:'제주 한라산 트레일런. 제주 서귀포 개최.',url:'https://www.trail.or.kr',participants:'500명',lat:33.36,lng:126.49,distances:'20K·12K'},
  {id:147,title:'2026 전국 마스터즈수영대회',sport:'수영',icon:'🏊',venue:'수원 실내수영장',address:'경기 수원',start:'2026-10-15',end:'2026-10-18',status:'upcoming',region:'경기',desc:'2026 전국 마스터즈수영대회. 경기 수원 개최.',url:'https://www.swimming.or.kr',participants:'3,000명',lat:37.28,lng:127.044,distances:'자유형·배영'},
