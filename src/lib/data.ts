...
export const EVENTS:SportEvent[]=[
  ...
  {id:224,title:'2026 겨울 전국 수영 오픈',sport:'수영',icon:'🏊',venue:'워커힐 실내수영장',address:'서울 광진',start:'2026-12-13',end:'2026-12-14',status:'upcoming',region:'서울',desc:'2026 겨울 전국 수영 오픈. 서울 광진 개최.',url:'https://www.swimming.or.kr',participants:'600명',lat:37.5454,lng:127.0848,distances:'자유형·개인혼영'},
