...
export const EVENTS:SportEvent[]=[
  ...
  {id:4,title:'2026 JTBC 서울마라톤',sport:'마라톤',icon:'🏃',venue:'잠실올림픽주경기장',address:'서울 송파구 올림픽로 25',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'서울',desc:'추첨제. 풀·하프·10km.',url:'https://marathon.jtbc.com',participants:'30,000명',lat:37.5149,lng:127.0738,distances:'풀코스·하프·10K'},
  ...
  {id:13,title:'2026 전국수영선수권대회',sport:'수영',icon:'🏊',venue:'광주 남부대시립수영장',address:'광주 광산구 첨단과기로 208-1',start:'2026-10-15',end:'2026-10-18',status:'upcoming',region:'광주',desc:'전국 수영 최강자 선수권.',url:'https://swimming.or.kr',participants:'2,000명',lat:35.2196,lng:126.8472,distances:'자유형·배영·평영'},
  ...
  {id:42,title:'2026 전국마스터즈수영대회',sport:'수영',icon:'🏊',venue:'수원 실내수영장',address:'경기 수원시 영통구 대학4로 45',start:'2026-10-15',end:'2026-10-18',status:'upcoming',region:'경기',desc:'만 25세 이상 동호인 수영 오픈.',url:'https://swimming.or.kr',participants:'3,000명',lat:37.2804,lng:127.0444,distances:'자유형·배영·평영'},
  {id:43,title:'2026 전국오픈수영대회 (부산)',sport:'수영',icon:'🏊',venue:'부산국제수영장',address:'부산 해운대구 APEC로 58',start:'2026-11-05',end:'2026-11-08',status:'upcoming',region:'부산',desc:'국내외 선수들이 참가하는 오픈 수영.',url:'https://swimming.or.kr',participants:'1,000명',lat:35.1796,lng:129.1756,distances:'자유형·개인혼영'},
  {id:44,title:'2026 전국유도선수권',sport:'유도',icon:'🥋',venue:'충주 세계무술공원',address:'충북 충주시 대소원면',start:'2026-10-22',end:'2026-10-25',status:'upcoming',region:'충북',desc:'전국 유도 선수권대회.',url:'https://judo.or.kr',participants:'1,200명',lat:36.9567,lng:127.8941,distances:'남녀급별'},
  ...
  {id:50,title:'2026 전국탁구선수권',sport:'기타',icon:'🏓',venue:'대전 충무체육관',address:'대전 중구 보문로 246',start:'2026-10-14',end:'2026-10-18',status:'upcoming',region:'대전',desc:'전국 탁구 최강자 선발전.',url:'https://www.ta.or.kr',participants:'1,500명',lat:36.322,lng:127.4208,distances:'남녀단복식'},
  ...
  {id:53,title:'2026 전국조정선수권',sport:'기타',icon:'🚣',venue:'충주 탄금호 조정경기장',address:'충북 충주시 번영대로 24',start:'2026-10-08',end:'2026-10-12',status:'upcoming',region:'충북',desc:'전국 조정 남녀 선수권.',url:'https://rowing.or.kr',participants:'800명',lat:36.9701,lng:127.9255,distances:'싱글·더블·팀'},
  ...
  {id:176,title:'2026 전국 탁구선수권',sport:'기타',icon:'🏆',venue:'대전 충무체육관',address:'대전 중구',start:'2026-10-14',end:'2026-10-18',status:'upcoming',region:'대전',desc:'2026 전국 탁구선수권. 대전 중구 개최.',url:'https://www.ta.or.kr',participants:'1,500명',lat:36.322,lng:127.421,distances:'남녀단복식'},
  ...
  {id:213,title:'2026 대구 실내 배드민턴 오픈',sport:'배드민턴',icon:'🏸',venue:'대구체육관',address:'대구 수성',start:'2026-12-05',end:'2026-12-06',status:'upcoming',region:'대구',desc:'2026 대구 실내 배드민턴 오픈. 대구 수성 개최.',url:'https://www.badmintonkorea.org',participants:'1,000명',lat:35.8714,lng:128.6014,distances:'복식'},
  ...
  {id:216,title:'2026 전국 실내 자전거 경기',sport:'사이클',icon:'🚴',venue:'광명 스피돔',address:'경기 광명',start:'2026-12-12',end:'2026-12-13',status:'upcoming',region:'경기',desc:'2026 전국 실내 자전거 경기. 경기 광명 개최.',url:'https://www.koreacycling.or.kr',participants:'400명',lat:37.4458,lng:126.8522,distances:'트랙'},
  ...
  {id:218,title:'2026 한겨울 부산 해변 러닝',sport:'러닝',icon:'💨',venue:'해운대해수욕장',address:'부산 해운대',start:'2026-12-12',end:'2026-12-12',status:'upcoming',region:'부산',desc:'2026 한겨울 부산 해변 러닝. 부산 해운대 개최.',url:'https://www.kaaf.or.kr',participants:'3,000명',lat:35.1595,lng:129.074,distances:'10K·5K'},
  {id:220,title:'2026 겨울 배드민턴 클럽 리그',sport:'배드민턴',icon:'🏸',venue:'서울 실내체육관',address:'서울 강남',start:'2026-12-06',end:'2026-12-07',status:'upcoming',region:'서울',desc:'2026 겨울 배드민턴 클럽 리그. 서울 강남 개최.',url:'https://www.badmintonkorea.org',participants:'600명',lat:37.5155,lng:127.0729,distances:'복식'},
  ...
  {id:224,title:'2026 겨울 전국 수영 오픈',sport:'수영',icon:'🏊',venue:'워커힐 실내수영장',address:'서울 광진',start:'2026-12-13',end:'2026-12-14',status:'upcoming',region:'서울',desc:'2026 겨울 전국 수영 오픈. 서울 광진 개최.',url:'https://swimming.or.kr',participants:'600명',lat:37.5454,lng:127.0848,distances:'자유형·개인혼영'},
  ...
  {id:226,title:'2026 설 맞이 전국 씨름',sport:'기타',icon:'🏆',venue:'충주 세계무술공원',address:'충북 충주',start:'2026-12-19',end:'2026-12-20',status:'upcoming',region:'충북',desc:'2026 설 맞이 전국 씨름. 충북 충주 개최.',url:'https://www.sports.or.kr',participants:'800명',lat:36.9651,lng:127.8872,distances:'체급별'},

  // ── 실제 대회 추가 (2026-08-12 kormarathon.com 검증) ──
  {id:227,title:'2026 나이트레이스 인 부산',sport:'마라톤',icon:'🏃',venue:'광안리해수욕장',address:'부산 수영구',start:'2026-08-01',end:'2026-08-01',status:'upcoming',region:'부산',desc:'2026 나이트레이스 인 부산. 부산 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-night-race-in-busan',participants:'5,000명',lat:35.1531,lng:129.1183,distances:'7.21km'},
  {id:228,title:'2026 815런',sport:'러닝',icon:'🏃',venue:'상암 월드컵공원',address:'서울 마포구',start:'2026-08-15',end:'2026-08-15',status:'upcoming',region:'서울',desc:'2026 815런. 서울 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/815-run-2026',participants:'3,000명',lat:37.5683,lng:126.8971,distances:'8.15km'},
  {id:229,title:'2026 안양천 달빛 나이트 런',sport:'러닝',icon:'🏃',venue:'신정교 하부 영롱이 억새구장',address:'서울 양천구',start:'2026-08-15',end:'2026-08-15',status:'upcoming',region:'서울',desc:'2026 안양천 달빛 나이트 런. 서울 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-anyangcheon-moonlight-night-run',participants:'2,000명',lat:37.5263,lng:126.8623,distances:'5km·10km'},
  {id:230,title:'2026 HAPPY700 평창 대관령 전국 하프마라톤',sport:'마라톤',icon:'🏃',venue:'2018 평창동계올림픽 기념관 운동장',address:'강원 평창군',start:'2026-08-16',end:'2026-08-16',status:'upcoming',region:'강원',desc:'2026 HAPPY700 평창 대관령 전국 하프마라톤. 강원 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-happy700-pyeongchang-daegwallyeong-national-half-marathon',participants:'3,000명',lat:37.6301,lng:128.7185,distances:'10km·하프'},
  {id:231,title:'2026 대구세계마스터즈 육상경기대회',sport:'마라톤',icon:'🏃',venue:'대구스타디움',address:'대구 수성구',start:'2026-08-22',end:'2026-08-22',status:'upcoming',region:'대구',desc:'2026 대구세계마스터즈 육상경기대회. 대구 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/world-masters-athletics-championships-daegu-2026',participants:'10,000명',lat:35.8714,lng:128.6014,distances:'10km·하프'},
  {id:232,title:'제23회 철원DMZ 국제평화마라톤',sport:'마라톤',icon:'🏃',venue:'강원 철원군 고석정',address:'강원 철원군 동송읍',start:'2026-09-05',end:'2026-09-05',status:'upcoming',region:'강원',desc:'제23회 철원DMZ 국제평화마라톤. 강원 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/the-23rd-cheorwon-dmz-international-peace-marathon',participants:'5,000명',lat:38.2329,lng:127.3243,distances:'4km·10km·하프·풀코스'},
  {id:233,title:'봉화송이 전국마라톤대회',sport:'마라톤',icon:'🏃',venue:'봉화공설운동장',address:'경북 봉화군',start:'2026-09-06',end:'2026-09-06',status:'upcoming',region:'경북',desc:'봉화송이 전국마라톤대회. 경북 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/bonghwa-songi-national-marathon',participants:'2,000명',lat:36.8933,lng:128.7314,distances:'5km·10km·하프'},
  {id:234,title:'2026 YTN 서울 투어마라톤',sport:'마라톤',icon:'🏃',venue:'서울광장',address:'서울 중구',start:'2026-09-06',end:'2026-09-06',status:'upcoming',region:'서울',desc:'2026 YTN 서울 투어마라톤. 서울 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/ytn-seoul-tour-marathon-2026',participants:'5,000명',lat:37.5666,lng:126.978,distances:'11km·하프'},
  {id:235,title:'2026 계란마라톤대회',sport:'마라톤',icon:'🏃',venue:'정서진 경인아라뱃길 여객터미널',address:'인천 서구',start:'2026-09-12',end:'2026-09-12',status:'upcoming',region:'인천',desc:'2026 계란마라톤대회. 인천 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-egg-marathon',participants:'3,000명',lat:37.5472,lng:126.5953,distances:'5km·10km·하프'},
  {id:236,title:'2026 청주 나이트 런 페스티벌',sport:'러닝',icon:'🏃',venue:'청주시 무심천 체육공원',address:'충북 청주시',start:'2026-09-12',end:'2026-09-12',status:'upcoming',region:'충북',desc:'2026 청주 나이트 런 페스티벌. 충북 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/night-run-in-cheongju-2026',participants:'3,000명',lat:36.6424,lng:127.489,distances:'5km·10km'},
  {id:237,title:'2026 양양 강변 전국 마라톤대회',sport:'마라톤',icon:'🏃',venue:'강원 양양군 웰컴센터 및 남대천',address:'강원 양양군',start:'2026-09-12',end:'2026-09-12',status:'upcoming',region:'강원',desc:'2026 양양 강변 전국 마라톤대회. 강원 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-yangyang-riverside-national-marathon',participants:'3,000명',lat:38.0753,lng:128.6186,distances:'5km·10km·하프'},
  {id:238,title:'2026 포항2차전지 전국마라톤대회',sport:'마라톤',icon:'🏃',venue:'포항운하관 주차장',address:'경북 포항시',start:'2026-09-13',end:'2026-09-13',status:'upcoming',region:'경북',desc:'2026 포항2차전지 전국마라톤대회. 경북 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-pohang-secondary-battery-national-marathon',participants:'5,000명',lat:36.019,lng:129.3435,distances:'5km·10km·하프'},
  {id:239,title:'제26회 인천송도국제마라톤대회',sport:'마라톤',icon:'🏃',venue:'국립인천대학교 송도캠퍼스',address:'인천 연수구',start:'2026-09-20',end:'2026-09-20',status:'upcoming',region:'인천',desc:'제26회 인천송도국제마라톤대회. 인천 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/26th-incheon-songdo-international-marathon',participants:'8,000명',lat:37.3762,lng:126.6563,distances:'5km·10km·하프'},
  {id:240,title:'2026 동대문 마라톤',sport:'마라톤',icon:'🏃',venue:'중랑천 제1체육공원',address:'서울 동대문구',start:'2026-09-20',end:'2026-09-20',status:'upcoming',region:'서울',desc:'2026 동대문 마라톤. 서울 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/dongdaemun-marathon-2026',participants:'3,000명',lat:37.5791,lng:127.0447,distances:'5km·10km·하프'},
  {id:241,title:'제19회 가평자라섬 전국마라톤',sport:'마라톤',icon:'🏃',venue:'가평종합운동장',address:'경기 가평군',start:'2026-09-20',end:'2026-09-20',status:'upcoming',region:'경기',desc:'제19회 가평자라섬 전국마라톤. 경기 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/19th-gapyeong-jaraseom-national-marathon-2026',participants:'5,000명',lat:37.8315,lng:127.5118,distances:'4.2km·5km·10km·하프'},
  {id:242,title:'2026 공주백제마라톤',sport:'마라톤',icon:'🏃',venue:'공주시민운동장',address:'충남 공주시',start:'2026-09-20',end:'2026-09-20',status:'upcoming',region:'충남',desc:'2026 공주백제마라톤. 충남 개최. kormarathon.com 확인 대회.',url:'https://www.kormarathon.com/ko/races/2026-gongju-baekje-marathon',participants:'8,000명',lat:36.4461,lng:127.1189,distances:'5km·10km·하프·풀코스'},

  // ── 공식 검증 대회 (2026-08-12 공식사이트 검증) ──
  {id:243,title:'2026 코리아 마스터즈 배드민턴선수권대회',sport:'배드민턴',icon:'🏸',venue:'이순신체육관',address:'충남 아산시',start:'2026-08-04',end:'2026-08-09',status:'upcoming',region:'충남',desc:'2026 코리아 마스터즈 배드민턴선수권대회. 충남 개최.',url:'https://www.badmintonkorea.org',participants:'미정',lat:36.7838,lng:127.0038,distances:'BWF Super300'},
  {id:244,title:'제45회 대통령배 전국수영대회',sport:'수영',icon:'🏊',venue:'전주완산수영장',address:'전북 전주시',start:'2026-08-07',end:'2026-08-11',status:'upcoming',region:'전북',desc:'제45회 대통령배 전국수영대회. 전북 개최.',url:'https://www.korswim.co.kr',participants:'미정',lat:35.8242,lng:127.1479,distances:'경영·다이빙·수구·아티스틱'},
  {id:245,title:'2026 전국다문화가족 배드민턴대회',sport:'배드민턴',icon:'🏸',venue:'고양 소노 아레나',address:'경기 고양시 일산서구',start:'2026-08-08',end:'2026-08-08',status:'upcoming',region:'경기',desc:'2026 전국다문화가족 배드민턴대회. 경기 개최.',url:'https://www.courtx.co.kr/Tournament/Details/30311',participants:'500명',lat:37.6661,lng:126.7691,distances:'혼합복식·중고등부·초등부'},
  {id:246,title:'2026 평택시장배 배드민턴대회',sport:'배드민턴',icon:'🏸',venue:'이충문화체육센터·이충실내배드민턴장',address:'경기 평택시',start:'2026-09-05',end:'2026-09-06',status:'upcoming',region:'경기',desc:'2026 평택시장배 배드민턴대회. 경기 개최.',url:'https://www.courtx.co.kr/Tournament/Details/30326',participants:'미정',lat:37.0073,lng:127.0328,distances:'복식·혼합복식·단식'},
  {id:247,title:'2026 GES 전국 아마추어 이스포츠 대회',sport:'기타',icon:'🏆',venue:'광주이스포츠경기장',address:'광주 서구',start:'2026-09-12',end:'2026-09-12',status:'upcoming',region:'광주',desc:'2026 GES 전국 아마추어 이스포츠 대회. 광주 개최.',url:'https://esports.sooplive.com/gggl/tournament/gjesports01/2741',participants:'미정',lat:35.1341,lng:126.8468,distances:'발로란트·브롤스타즈'},

  // ── 가을 시즌 + 심사 대비 골든패스 (2026-08-31 가을시즌·심사대비) ──
  {id:248,title:'2026 춘천마라톤',sport:'마라톤',icon:'🏃',venue:'춘천 공지천교',address:'강원 춘천시 공지천로',start:'2026-10-25',end:'2026-10-25',status:'upcoming',region:'강원',desc:'2026 춘천마라톤. 강원 개최.',url:'https://www.kormarathon.com/ko/races/2026-chuncheon-marathon',participants:'30000명',lat:37.8747,lng:127.7341,distances:'하프·풀코스'},
  {id:249,title:'2026 JTBC 서울마라톤',sport:'마라톤',icon:'🏃',venue:'잠실종합운동장',address:'서울 송파구',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'서울',desc:'2026 JTBC 서울마라톤. 서울 개최.',url:'https://www.kormarathon.com/ko/races/jtbc-seoul-marathon-2026',participants:'25000명',lat:37.5155,lng:127.0729,distances:'10km·하프·풀코스'},
  {id:250,title:'2026 경주국제마라톤',sport:'마라톤',icon:'🏃',venue:'경주종합운동장',address:'경북 경주시',start:'2026-10-11',end:'2026-10-11',status:'upcoming',region:'경북',desc:'2026 경주국제마라톤. 경북 개최.',url:'https://www.kormarathon.com/ko/races/2026-gyeongju-international-marathon',participants:'15000명',lat:35.8563,lng:129.2167,distances:'10km·하프·풀코스'},
  {id:251,title:'2026 전주마라톤',sport:'마라톤',icon:'🏃',venue:'전주종합운동장',address:'전북 전주시',start:'2026-10-04',end:'2026-10-04',status:'upcoming',region:'전북',desc:'2026 전주마라톤. 전북 개최.',url:'https://www.kormarathon.com/ko/races/2026-jeonju-marathon',participants:'8000명',lat:35.8219,lng:127.1489,distances:'5km·10km·하프·풀코스'},
  {id:252,title:'2026 서울국제마라톤 (동아)',sport:'마라톤',icon:'🏃',venue:'광화문광장',address:'서울 종로구',start:'2026-11-01',end:'2026-11-01',status:'upcoming',region:'서울',desc:'2026 서울국제마라톤 (동아). 서울 개최.',url:'https://www.kormarathon.com/ko/races/2026-seoul-international-marathon',participants:'40000명',lat:37.576,lng:126.9769,distances:'풀코스'},
  {id:253,title:'2026 부산마라톤',sport:'마라톤',icon:'🏃',venue:'부산시민공원',address:'부산 부산진구',start:'2026-10-25',end:'2026-10-25',status:'upcoming',region:'부산',desc:'2026 부산마라톤. 부산 개최.',url:'https://www.kormarathon.com/ko/races/2026-busan-marathon',participants:'12000명',lat:35.1859,lng:129.0739,distances:'10km·하프·풀코스'},
  {id:254,title:'2026 대전마라톤',sport:'마라톤',icon:'🏃',venue:'대전천변',address:'대전 중구',start:'2026-10-18',end:'2026-10-18',status:'upcoming',region:'대전',desc:'2026 대전마라톤. 대전 개최.',url:'https://www.kormarathon.com/ko/races/2026-daejeon-marathon',participants:'5000명',lat:36.3229,lng:127.4255,distances:'5km·10km·하프'},
  {id:255,title:'2026 제주마라톤',sport:'마라톤',icon:'🏃',venue:'제주경마공원',address:'제주 서귀포시',start:'2026-11-08',end:'2026-11-08',status:'upcoming',region:'제주',desc:'2026 제주마라톤. 제주 개최.',url:'https://www.kormarathon.com/ko/races/2026-jeju-marathon',participants:'5000명',lat:33.4512,lng:126.3248,distances:'10km·하프·풀코스'},
  {id:256,title:'2026 광주마라톤',sport:'마라톤',icon:'🏃',venue:'광주월드컵경기장',address:'광주 서구',start:'2026-11-01',end:'2026-11-01',status:'upcoming',region:'광주',desc:'2026 광주마라톤. 광주 개최.',url:'https://www.kormarathon.com/ko/races/2026-gwangju-marathon',participants:'5000명',lat:35.1679,lng:126.8974,distances:'5km·10km·하프'},
  {id:257,title:'2026 인천마라톤',sport:'마라톤',icon:'🏃',venue:'인천문학경기장',address:'인천 미추홀구',start:'2026-10-25',end:'2026-10-25',status:'upcoming',region:'인천',desc:'2026 인천마라톤. 인천 개최.',url:'https://www.kormarathon.com/ko/races/2026-incheon-marathon',participants:'8000명',lat:37.4478,lng:126.7052,distances:'10km·하프·풀코스'},
  {id:258,title:'2026 동아국제마라톤',sport:'마라톤',icon:'🏃',venue:'올림픽공원',address:'서울 송파구',start:'2026-12-06',end:'2026-12-06',status:'upcoming',region:'서울',desc:'2026 동아국제마라톤. 서울 개최.',url:'https://www.kormarathon.com/ko/races/2026-dong-a-international-marathon',participants:'10000명',lat:37.5218,lng:127.1234,distances:'하프·풀코스'},
  {id:259,title:'2026 조선일보 춘천마라톤',sport:'마라톤',icon:'🏃',venue:'춘천시청',address:'강원 춘천시',start:'2026-11-15',end:'2026-11-15',status:'upcoming',region:'강원',desc:'2026 조선일보 춘천마라톤. 강원 개최.',url:'https://www.kormarathon.com/ko/races/chosun-chuncheon-marathon-2026',participants:'8000명',lat:37.8813,lng:127.7299,distances:'10km·하프·풀코스'},
  {id:260,title:'제65회 전국남녀 배드민턴선수권',sport:'배드민턴',icon:'🏃',venue:'장충체육관',address:'서울 중구',start:'2026-10-14',end:'2026-10-18',status:'upcoming',region:'서울',desc:'제65회 전국남녀 배드민턴선수권. 서울 개최.',url:'https://www.badmintonkorea.org',participants:'미정',lat:37.5596,lng:126.9991,distances:'복식·단식'},
  {id:261,title:'2026 전국수영선수권대회',sport:'수영',icon:'🏃',venue:'국민체육센터',address:'경기 수원시',start:'2026-10-20',end:'2026-10-24',status:'upcoming',region:'경기',desc:'2026 전국수영선수권대회. 경기 개최.',url:'https://www.korswim.co.kr',participants:'미정',lat:37.2636,lng:127.0286,distances:'경영·다이빙'},
  {id:262,title:'제50회 전국테니스선수권',sport:'테니스',icon:'🏃',venue:'올림픽테니스장',address:'서울 송파구',start:'2026-11-10',end:'2026-11-15',status:'upcoming',region:'서울',desc:'제50회 전국테니스선수권. 서울 개최.',url:'https://www.kortennis.co.kr',participants:'미정',lat:37.5218,lng:127.1218,distances:'단식·복식'},
  {id:263,title:'2026 전국사이클선수권대회',sport:'사이클',icon:'🏃',venue:'영천시자전거도로',address:'경북 영천시',start:'2026-10-08',end:'2026-10-10',status:'upcoming',region:'경북',desc:'2026 전국사이클선수권대회. 경북 개최.',url:'https://www.koreacycling.or.kr',participants:'미정',lat:35.9733,lng:128.9381,distances:'도로·트랙'},
  {id:264,title:'제44회 전국태권도선수권',sport:'태권도',icon:'🏃',venue:'수원실내체육관',address:'경기 수원시',start:'2026-10-27',end:'2026-10-30',status:'upcoming',region:'경기',desc:'제44회 전국태권도선수권. 경기 개최.',url:'https://www.koreataekwondo.org',participants:'미정',lat:37.2898,lng:127.0138,distances:'품새·겨루기'},
];
